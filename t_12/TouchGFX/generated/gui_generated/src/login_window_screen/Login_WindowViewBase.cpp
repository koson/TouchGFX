...
Login_WindowViewBase::Login_WindowViewBase() :
    buttonCallback(this, &Login_WindowViewBase::buttonCallbackHandler)
{
...
void Login_WindowViewBase::setupScreen()
{

}

void Login_WindowViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
