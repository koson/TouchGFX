...
Graphics_WindowViewBase::Graphics_WindowViewBase() :
    buttonCallback(this, &Graphics_WindowViewBase::buttonCallbackHandler)
{
...
void Graphics_WindowViewBase::setupScreen()
{

}

void Graphics_WindowViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
